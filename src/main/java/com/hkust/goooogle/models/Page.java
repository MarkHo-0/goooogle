...
public record Page(String url, String title, String lastModifyTime, int contentSize, Map<String, Integer> keywordsWithCounts, List<Page> childPages, List<Page> parentPages, float score) {
